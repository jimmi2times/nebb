...
* [Responsive Accordion And Collapse](http://demo.wpshopmart.com/responsive-accordion-and-collapse/)
...
* [Upgrade To Accordion Pro](http://wpshopmart.com/plugins/accordion-pro/)
...
4. Copy your publish accordion shortcode and then paste into your page or post to display your accordion
...
1. Accordion with right side open/close icon
2. Accordion with title icon
3. Accordion without any icon 
4. Accordion with different background colour
5. Collapse/toggle enable
6. Accordion drag and drop option
